    ...
    <div className="space-y-7">
      <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4">
        ...
        {unreadCount > 0 && (
          <button
            onClick={markAllRead}
            className="px-4 py-2.5 rounded-xl bg-blue-600 hover:bg-blue-700 text-white font-semibold transition cursor-pointer"
          >
      ...
      {loading ? (
        ...
        <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl py-20 text-center">
          ...
          <p className="text-slate-500 dark:text-slate-400 mt-2">
            New placement and interview updates will appear here.
          </p>
        </div>
      ) : (
        <div className="space-y-3">
            ...
            <div
              ...
              className={`p-5 rounded-2xl border transition ${
                notification.read
                  ...
                  : "bg-blue-50 dark:bg-blue-500/5 border-blue-200 dark:border-blue-500/20 cursor-pointer hover:border-blue-300"
              }`}
            >
