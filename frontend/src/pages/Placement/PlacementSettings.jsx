    ...
    <div className="max-w-5xl space-y-7">
      <div>
        ...
        <p className="text-slate-500 dark:text-slate-400 mt-2">
          Configure your placement management preferences and appearance.
        </p>
      </div>
      ...
      <div className="space-y-4">
        ...
        <Setting
          icon="🔔"
          title="Notifications"
          description="Receive instant alerts for new student applications and drive updates."
        >
        ...
        <Setting
          icon="🔐"
          title="Security"
          description="Update your placement officer account password."
        >
          <button
        ...
        <Setting
          icon="🏫"
          title="Portal Info"
          description="Campus placement system version and status."
        >
